...
If you implement your own signal handlers, make sure that your Worker process shuts down cleanly after receiving SIGTERM. Default SIGTERM and SIGINT handlers will terminate the Worker before the next loop cycle.
