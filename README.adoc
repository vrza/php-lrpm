...
This talk by Giorgio Sironi given at the Dutch PHP Conference in 2017 (https://youtu.be/MJkFHMOCEkg) covers some of the problems and challenges when implementing long running PHP processes.
